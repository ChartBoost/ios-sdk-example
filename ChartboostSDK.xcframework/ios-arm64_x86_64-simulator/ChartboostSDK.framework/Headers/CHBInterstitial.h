...
/*!
 ...
 @discussion To show an interstitial it first needs to be cached. Trying to show an uncached interstitial will always fail, thus it is recommended to always check if the ad is cached first.
...
/*!
 @brief The initializer for interstitial ads intended to be mediated by another SDK.
 @param location Location for the interstitial ad. See the location property documentation.
...
/*!
 @brief Please use -[CHBInterstitial initWithLocation:delegate:] instead.
*/
